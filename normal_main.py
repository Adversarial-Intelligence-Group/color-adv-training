...
class Main:
    ...
    #     self.model.eval()
    #     clean_probabilities, labels = common.test.test(self.model, self.testloader, cuda=self.args.cuda, return_labels=True)
    ...
    #                                                               attack, objective, attempts=3, cuda=self.args.cuda)
