...
class L2Projection(Projection):
    ...
    def __call__(self, images, perturbations):
        ...
        perturbations.data = common.torch.project_ball(perturbations.data, self.epsilon)
...
class L1Projection(Projection):
    ...
    def __call__(self, images, perturbations):
        ...
        perturbations.data = common.torch.project_ball(perturbations.data, self.epsilon, ord=1)


class L0Projection(Projection):
    """
    L_0 projection.
    """
    ...
    def __call__(self, images, perturbations):
        ...
        perturbations.data = common.torch.project_ball(perturbations.data, self.epsilon, ord=0)
